...
- M2: doc suite incl. the case round's regression classes + cycle-breaking + floor recipe. M3: brief-parity, witness fixture, no-giveaway gates, banned-words check ("admissible", "thrown out", "suppressed", "excluded", "hold up in court", "inadmissible"), Canvas zip independently verified.
